...
class deeperActor:
    ...
    def __init__(self, num_input, max_actions, entropy_penalty=0.01, lr=0.001):
    ...
    def __build_network(self):
        ...
        # logits = Lambda(self.tf_log)(x)         #[batch_size, max_actions]
        # decision = Lambda(self.tf_multinomial)(logits)          #[batch_size, max_actions,1]
        # print(decision.shape)
        # decision = Lambda(self.tf_reshape)(decision)           #[batch_size, max_actions]
        # print(decision.shape)
    ...
    #     self.model = self.model.compile(optimizer=optimizer,
    #           loss=loss,
    #           metrics=metrics)
    ...
    # '''
    # input shape: [batch_size, max_actions,1]
    # output shape: [batch_size, max_actions]
    # '''
    # def tf_reshape(self, decision):
    #     decision = tf.reshape(decision, [-1, self.max_actions])  # [batch_size, max_actions]
    #     return tf.cast(decision, tf.float32)
